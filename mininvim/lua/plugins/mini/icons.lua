local icon_groups = {
  eslint = {
    files = {
      ...
      '.eslintrc.cjs', '.eslintrc.mjs', '.eslintrc.ts',
      'eslint.config.js', 'eslint.config.json', 'eslint.config.yaml',
      'eslint.config.yml', 'eslint.config.cjs', 'eslint.config.mjs', 'eslint.config.ts',
    },
    glyph = '󰱺',
    type = 'file',
    hl = 'MiniIconsPurple',
  ...
  ts = {
    files = {
      ...
      'tsconfig.server.json', 'tsconfig.web.json', 'tsconfig.client.json',
    },
    glyph = '',
    type = 'file',
    hl = 'MiniIconsAzure',
